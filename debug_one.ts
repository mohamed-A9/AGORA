...
async function debugOne(name: string, city: string) {
    ...
    const searchUrl = `https://maps.googleapis.com/maps/api/place/findplacefromtext/json?input=${query}&inputtype=textquery&fields=place_id,name&key=${GOOGLE_PLACES_API_KEY}`;
